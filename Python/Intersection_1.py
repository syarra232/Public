...
def usage():
    ...
    print(f'       For e.g.: python3 Intersection.py L1.txt L2.txt R.txt')
...
def main(argv):
    ...
    emails_intersection = SetOps.SetOps.Intersection(emails_from_file1, emails_from_file2)
    return writeEmailsToFile(argv[2], emails_intersection)
